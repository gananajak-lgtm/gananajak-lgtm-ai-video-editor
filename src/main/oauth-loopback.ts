...
export async function startOAuthLoopback(expectedState:string, timeoutMs=120_000):Promise<OAuthLoopback> {
  let close=()=>{};
  ...
  return {redirectUri:`http://127.0.0.1:${address.port}`,callback,close};
}
