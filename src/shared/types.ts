...
export type DesktopApi = {
  ...
  connectMeta: () => Promise<Array<{id:string;name:string;accessToken:string;instagramBusinessAccountId?:string}>>;
  getMetaDestinations: () => Promise<Array<{id:string;name:string;accessToken:string;instagramBusinessAccountId?:string}>>;
